...
describe("Media Entity", () => {
    it("should return an error message when the field 'link' is not provided", () => {
      ...
      expect(Media.create(media).errorValue()).toBe("link is not provided or incorrect");
    });
    ...
    it("should return an error message when the field 'name' is not provided", () => {
        ...
        expect(Media.create(media).errorValue()).toBe("name is not provided or incorrect");
    });
